...
`GoogleAdsApi` is a python package makes it easy to get marketing data from Facebook into python.
...
from GoogleAdsApi.enums import FIELD_SOURCE, FIELD_CAMPAIGN, FIELD_CLICKS
